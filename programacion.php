            ...
            <div class="card">
                ...
                <div class="card-body">                                                          
                    ...
                    <div class="text-center">
                        <img src="img/logo-html.png" class="img-programacion" alt="logo-html" height="50px">
                        <img src="img/logo-php.png" class="img-programacion" alt="logo-php" height="50px">
                        <img src="img/logo-laravel.png" class="img-programacion" alt="logo-laravel" height="50px">
                        <img src="img/logo-mysql.png" class="img-programacion" alt="logo-mysql" height="50px">
